...
def main():
    ...
    # individual_decentralized_joint_rewards_policy_maker1 = MDP_Individual_Decentralized_policy_maker_oneDBoxes2(terrain1.matrix, individual_decentralized_joint_rewards_policy_map1_file)
    # individual_decentralized_split_rewards_policy_maker1 = MDP_Individual_Decentralized_policy_maker_oneDBoxes2(terrain1.matrix, individual_decentralized_split_rewards_policy_map1_file)
    # peer_aware_decentralized_joint_rewards_policy_maker1 = MDP_Peer_Aware_Decentralized_policy_maker_oneDBoxes2(terrain1.matrix, peer_aware_decentralized_joint_rewards_policy_map1_file)
    # peer_aware_decentralized_split_rewards_policy_maker1 = MDP_Peer_Aware_Decentralized_policy_maker_oneDBoxes2(terrain1.matrix, peer_aware_decentralized_split_rewards_policy_map1_file)
    # peer_communication_decentralized_joint_rewards_policy_maker1 = MDP_Peer_Communication_Decentralized_policy_maker_oneDBoxes2(terrain1.matrix, peer_communication_decentralized_joint_rewards_policy_map1_file)
    # peer_communication_decentralized_split_rewards_policy_maker1 = MDP_Peer_Communication_Decentralized_policy_maker_oneDBoxes2(terrain1.matrix, peer_communication_decentralized_split_rewards_policy_map1_file)

    # centralized_policy_maker_map2 = MDP_Centralized_policy_maker_oneDBoxes2(terrain2.matrix, centralized_policy_map2_file)
    # individual_decentralized_joint_rewards_policy_maker2 = MDP_Individual_Decentralized_policy_maker_oneDBoxes2(terrain2.matrix, individual_decentralized_joint_rewards_policy_map2_file)
    # individual_decentralized_split_rewards_policy_maker2 = MDP_Individual_Decentralized_policy_maker_oneDBoxes2(terrain2.matrix, individual_decentralized_split_rewards_policy_map2_file)
    # peer_aware_decentralized_joint_rewards_policy_maker2 = MDP_Peer_Aware_Decentralized_policy_maker_oneDBoxes2(terrain2.matrix, peer_aware_decentralized_joint_rewards_policy_map2_file)
    # peer_aware_decentralized_split_rewards_policy_maker2 = MDP_Peer_Aware_Decentralized_policy_maker_oneDBoxes2(terrain2.matrix, peer_aware_decentralized_split_rewards_policy_map2_file)
    # peer_communication_decentralized_joint_rewards_policy_maker2 = MDP_Peer_Communication_Decentralized_policy_maker_oneDBoxes2(terrain2.matrix, peer_communication_decentralized_joint_rewards_policy_map2_file)
    # peer_communication_decentralized_split_rewards_policy_maker2 = MDP_Peer_Communication_Decentralized_policy_maker_oneDBoxes2(terrain2.matrix, peer_communication_decentralized_split_rewards_policy_map2_file)

    # centralized_policy_maker_map3 = MDP_Centralized_policy_maker_oneDBoxes2(terrain3.matrix, centralized_policy_map3_file)
    # individual_decentralized_joint_rewards_policy_maker3 = MDP_Individual_Decentralized_policy_maker_oneDBoxes2(terrain3.matrix, individual_decentralized_joint_rewards_policy_map3_file)
    # individual_decentralized_split_rewards_policy_maker3 = MDP_Individual_Decentralized_policy_maker_oneDBoxes2(terrain3.matrix, individual_decentralized_split_rewards_policy_map3_file)
    # peer_aware_decentralized_joint_rewards_policy_maker3 = MDP_Peer_Aware_Decentralized_policy_maker_oneDBoxes2(terrain3.matrix, peer_aware_decentralized_joint_rewards_policy_map3_file)
    # peer_aware_decentralized_split_rewards_policy_maker3 = MDP_Peer_Aware_Decentralized_policy_maker_oneDBoxes2(terrain3.matrix, peer_aware_decentralized_split_rewards_policy_map3_file)
    # peer_communication_decentralized_joint_rewards_policy_maker3 = MDP_Peer_Communication_Decentralized_policy_maker_oneDBoxes2(terrain3.matrix, peer_communication_decentralized_joint_rewards_policy_map3_file)
    # peer_communication_decentralized_split_rewards_policy_maker3 = MDP_Peer_Communication_Decentralized_policy_maker_oneDBoxes2(terrain3.matrix, peer_communication_decentralized_split_rewards_policy_map3_file)
