...
def main():
    ...
    # individual_decentralized_joint_rewards_policy_maker1 = MDP_Individual_Decentralized_policy_maker_oneDBoxes2(terrain1.matrix, individual_decentralized_joint_rewards_policy_map1_file, True)
    ...
    # individual_decentralized_joint_rewards_policy_maker3 = MDP_Individual_Decentralized_policy_maker_oneDBoxes2(terrain3.matrix, individual_decentralized_joint_rewards_policy_map3_file, True)
