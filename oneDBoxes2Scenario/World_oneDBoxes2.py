        ...
        for column in range(len(self.terrain.matrix[0])):
            for line in range(len(self.terrain.matrix)):
                if self.terrain.matrix[line][column] == 3:
                    shappy = Shappy_oneDBoxes2('A', column * self.screen_ratio, line * self.screen_ratio, self, 3,
                ...
                if self.terrain.matrix[line][column] == 4:
                    shappy = Shappy_oneDBoxes2('B', column * self.screen_ratio, line * self.screen_ratio, self,
