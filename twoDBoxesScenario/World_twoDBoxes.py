...
from twoDBoxesScenario.Box_twoDBoxes import *
from twoDBoxesScenario.Shappy_twoDBoxes import *
from copy import *
import pickle


class World_twoDBoxes(object):
    ...
    def __init__(self, terrain, policy_file, type_of_policy):
        ...
        for column in range(len(self.terrain.matrix[0])):
            for line in range(len(self.terrain.matrix)):
                if self.terrain.matrix[line][column] == 3:
                    shappy = Shappy_twoDBoxes('A', column * self.screen_ratio, line * self.screen_ratio, self, 3,
                ...
                if self.terrain.matrix[line][column] == 4:
                    shappy = Shappy_twoDBoxes('B', column * self.screen_ratio, line * self.screen_ratio, self,
        ...
        #
        #     shappy = Shappy_twoDBoxes(shappy_var[0],shappy_var[1], shappy_var[3] * self.screen_ratio, shappy_var[2] * self.screen_ratio,
